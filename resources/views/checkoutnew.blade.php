                    ...
                    <div id="shippingAddress" class="row g-4 mt-5">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select custome-form-select" id="city" name="city">
                                ...
                                <option value="Andhra Pradesh">Butuan City</option>
                                <option value="Arunachal Pradesh">Ampayon</option>
                                <option value="Arunachal Pradesh">Surigao</option>
                            </select>
                        </div>
                        <div class="col-md-3">
                            <label for="zip" class="form-label">Zip</label>
...
@push('scripts')
    <script>
        // Script to show additional fields based on payment method selection
